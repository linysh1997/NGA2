...
contains
   ...
   !> Function that localizes the left (y-) of the domain
   ...
   !> Function that localizes the right (y+) of the domain
   ...
   !> Function that localizes the left (z-) of the domain
   ...
   !> Function that localizes the right (z+) of the domain
